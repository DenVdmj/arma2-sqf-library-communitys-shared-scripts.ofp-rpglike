//
//
// Функция funcGetTimeInHumanFormat
// Синтаксис:
//      daytime call funcGetTimeInHumanFormat
// Возвращает время преобразованное в строку на русском языке.
// Возвращаемая строка имеет форуму ответа на вопрос «который час?», например:
//  — половина шестого.
//  — без пяти три.
//
